    ...
    public function accessRules() {
        return array(
            array('allow', // allow all users to perform 'index' and 'view' actions
                'actions' => array('index', 'view', 'smart'),
                'users' => array('*'),
            ),
...
//            $criteria->addSearchCondition("concat(concat(concat( concat(nombre ,' '), apellido_paterno),' '), apellido_materno)", $name, true);
//
//            $employees = Employee::model()->findAll($criteria);
//
//            foreach ($employees as $employee) {
//                $myFullName = $employee->FIRST_NAME . ' ' . $employee->LAST_NAME . ' ' . $employee->EMAIL;
//                $returnValues[] = array(
//                    'value' => $myFullName,
